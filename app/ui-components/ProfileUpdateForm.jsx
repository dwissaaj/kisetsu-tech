...
export default function ProfileUpdateForm(props) {
  ...
  const [currentJobValue, setCurrentJobValue] = React.useState("");
      ...
      <ArrayField
        onChange={async (items) => {
          ...
          if (onChange) {
            ...
            const result = onChange(modelFields);
            values = result?.job ?? values;
          }
          setJob(values);
          setCurrentJobValue("");
        }}
        currentFieldValue={currentJobValue}
        label={"Job"}
        items={job}
        hasError={errors?.job?.hasError}
        runValidationTasks={async () =>
          await runValidationTasks("job", currentJobValue)
        }
        errorMessage={errors?.job?.errorMessage}
        setFieldValue={setCurrentJobValue}
        inputFieldRef={jobRef}
        defaultFieldValue={""}
      >
        <TextField
          label="Job"
          ...
          onChange={(e) => {
            ...
            setCurrentJobValue(value);
          }}
          onBlur={() => runValidationTasks("job", currentJobValue)}
          errorMessage={errors.job?.errorMessage}
          hasError={errors.job?.hasError}
          ref={jobRef}
          labelHidden={true}
